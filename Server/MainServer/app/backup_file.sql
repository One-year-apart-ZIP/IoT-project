...
--
-- Host: localhost    Database: my_iot_db
-- ------------------------------------------------------
...
LOCK TABLES `energy_data` WRITE;
/*!40000 ALTER TABLE `energy_data` DISABLE KEYS */;
INSERT INTO `energy_data` VALUES
(1,NULL,23.5,60.5,0.03);
/*!40000 ALTER TABLE `energy_data` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `uploaded_file` (
  ...
  `timestamp` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `ix_uploaded_file_timestamp` (`timestamp`)
...
-- Dump completed on 2024-03-15 19:05:25
